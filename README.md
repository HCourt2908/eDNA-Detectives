...
1. **Observe** — compare the 20-year baseline seamount and today's seamount side by side, hover or keyboard-focus a species for facts, and record at least four observations from the current map. Notebook observations scroll inside their own reserved region while the compact stage CTA remains fixed and centered at the bottom.
