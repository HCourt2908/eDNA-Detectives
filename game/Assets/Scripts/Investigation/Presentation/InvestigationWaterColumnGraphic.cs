...
namespace EDNA.Investigation
{
    ...
    public sealed class InvestigationWaterColumnGraphic : MaskableGraphic
    {
        ...
        private static Color32 StopColor(int index)
        {
            switch (index)
            {
                case 0: return InvestigationTheme.WaterFloor;
                case 1: return InvestigationTheme.WaterLower;
                case 2: return InvestigationTheme.WaterUpper;
                default: return InvestigationTheme.WaterTop;
            }
        }
