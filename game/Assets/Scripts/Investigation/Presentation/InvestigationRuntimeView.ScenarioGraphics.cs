...
namespace EDNA.Investigation
{
    public sealed partial class InvestigationRuntimeView
    {
        ...
        private void RenderScenarioObservedPattern(Transform parent)
        {
            ...
            TextMeshProUGUI heading = CreateText("Scenario Survey Target Title", paper, "FROM MY NOTEBOOK · 20 YEARS AGO → TODAY", 12,
            ...
            for (int i = 0; i < ids.Count; i++)
            {
                ...
                TextMeshProUGUI name = CreateText("Observed Species", tile, species.GameplayName, 13,
                ...
                TextMeshProUGUI arrow = CreateText("Observed Time Arrow", tile, "→", 14, FontStyle.Bold, InvestigationTheme.PaperMuted, TextAnchor.MiddleCenter, InvestigationTheme.BodyFont);
                ...
                TextMeshProUGUI result = CreateText("Observed Change", tile, missing ? "Not detected" : finding?.ClaimType == ObservationClaimType.ChangedDepthOrDistribution ? "More sites"
