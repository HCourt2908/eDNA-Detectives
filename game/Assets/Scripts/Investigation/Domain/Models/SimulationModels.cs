...
namespace EDNA.Investigation.Domain
{
    ...
    public sealed class InvestigationReadiness
    {
        public InvestigationReadiness(
    ...
    public sealed class InvestigationConclusionResult
    {
        public InvestigationConclusionResult(InvestigationConclusionStatus status, string feedback)
        {
            Status = status;
            Feedback = feedback ?? string.Empty;
        }

        public InvestigationConclusionStatus Status { get; }
        public string Feedback { get; }
    }
}
