...
namespace EDNA.Investigation.V2
{
    ...
    public static class InvestigationV2QaStateFactory
    {
            ...
            InvestigationV2QaCheckpoint checkpoint)
        {
            ...
            Require(updater.TrySetPhase(state, InvestigationV2Phase.Simulate, out string simulateFeedback), simulateFeedback);
            ...
            Require(updater.TrySetPhase(state, InvestigationV2Phase.Report, out string reportFeedback), reportFeedback);
