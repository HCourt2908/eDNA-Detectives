...
{
    [CreateAssetMenu(menuName = "eDNA Detectives/Investigation V2/Species", fileName = "SpeciesV2_")]
    public sealed class InvestigationV2SpeciesDefinition : ScriptableObject
    {
