...
namespace EDNA.Investigation.V2
{
    ...
    public sealed class InvestigationV2RoundedCorners : MonoBehaviour
    {
        private static readonly Dictionary<int, Sprite> Sprites = new Dictionary<int, Sprite>();
        [SerializeField, Min(1f)] private float radius = InvestigationV2Theme.SmallRadius;
        ...
        private static Sprite GetOrCreateSprite(int requestedRadius)
        {
            ...
            {
                name = $"Investigation V2 Rounded Rectangle {pixelRadius}px",
