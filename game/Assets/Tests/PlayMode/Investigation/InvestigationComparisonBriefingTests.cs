...
namespace EDNA.Investigation.Tests
{
    public sealed class InvestigationComparisonBriefingTests
    {
        ...
        private static string Speaker => GameObject.Find("Comparison Briefing Speaker").GetComponent<TextMeshProUGUI>().text;
        ...
        [UnityTest] public IEnumerator Briefing_RevealsNotebookSpeciesAndChangesOnlyAfterNext()
        {
            ...
            Assert.That(GameObject.Find("Comparison Briefing Next").GetComponentInChildren<TextMeshProUGUI>().text,Does.Contain("Start comparing"));
            Press("Comparison Briefing Next");yield return null;
        ...
        [UnityTest] public IEnumerator Briefing_CompactLayoutKeepsTheSpotlightAndNextVisibleAcrossRefreshes()
        {
            ...
            try
            {
                ...
                for(int step=1;step<=3;step++)
                {
                    ...
                    foreach(TextMeshProUGUI text in GameObject.Find("Comparison Briefing Speech").GetComponentsInChildren<TextMeshProUGUI>())
