...
The original SVG files were rasterized to 512×512 transparent PNG files for Unity. The artwork itself was not redrawn.

Heroicons is distributed under the MIT License. The complete license text is included in `LICENSE.txt`.
